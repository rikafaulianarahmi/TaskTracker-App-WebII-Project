                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <?php if ($canManage): ?>
                                        <div class="flex items-center gap-2">
                                            ...
                                            <form action="<?= site_url('tasks/' . esc($task['id']) . '/archive') ?>"
                                                method="post"
                                                onsubmit="return confirm('Archive this task?');">
                                                <?= csrf_field() ?>

                                                <button type="submit"
                                                        class="inline-flex items-center gap-1.5 border border-rose-100 bg-white hover:bg-rose-50 text-rose-600 py-1.5 px-2.5 rounded-lg text-xs font-bold transition-all duration-200 active:scale-95 shadow-sm"
                                                        title="Archive Task">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                        stroke-width="2.2" stroke="currentColor" class="w-3.5 h-3.5">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            d="m20.25 7.5-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5M9.75 11.25h4.5" />
                                                    </svg>
                                                    Archive
                                                </button>
                                            </form>
