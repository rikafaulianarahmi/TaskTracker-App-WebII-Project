...
<?= $this->section('title') ?>New Task - <?= esc($project['title']) ?><?= $this->endSection() ?>
...
<!-- Header -->
<div class="mb-8">
    <h2 class="text-3xl font-bold text-slate-900 tracking-tight">New Task</h2>
...
<div class="flex justify-center w-full py-4">
    <div class="w-full max-w-2xl bg-white border-t-4 border-t-[#4F46E5] border-x border-b border-slate-200 rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.015)] overflow-hidden">
        ...
        <form action="<?= site_url('projects/' . esc($project['id']) . '/tasks/store') ?>" method="post" class="p-8 space-y-6">
            <?= csrf_field() ?>
